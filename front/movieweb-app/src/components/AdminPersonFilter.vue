        ...
        <div class="basic-search-section">
            <div class="filter-row">
                <div class="filter-item">
                    ...
                    <el-input v-model="filters.personName" placeholder="Search by name or surname" clearable
                        @clear="applyFilters" @input="applyFilters" class="name-input">
                        <template #append>
            ...
            <el-collapse-item name="1" title="Advanced Search">
                <div class="advanced-search-section">
                    <div class="filter-item">
                        ...
                        <el-input v-model="filters.country" filterable clearable placeholder="Select country"
...
const clearFilters = () => {
    filters.value = { personName: '', country: null, genders: [] };
    applyFilters();
};
